...
const SUBJECT_ICON = {
  'Spotting Errors': '🔍', 'Reading Comprehension': '📖', 'Ordering of Words': '🔤',
  'Ordering of Sentences': '🧩', 'Fill in the Blanks': '✏️', 'Cloze': '📝',
  'Parts of Speech / Word Classes': '🏷️', 'Prepositions & Determiners': '🔗',
  'Sentence Completion': '➡️', 'Sentence Improvement': '⭐', 'Other Grammar': '📚'
};

function subjectTile(s) {
  const icon = SUBJECT_ICON[s.name] || '📘';
  return `<a class="subj-tile" href="browse.html?section=${encodeURIComponent(s.name)}">
