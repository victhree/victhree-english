...
function getBookmarks() {
  try { return new Set(JSON.parse(localStorage.getItem('vteng_bookmarks') || '[]')); }
  catch (e) { return new Set(); }
}
function saveBookmarks(set) {
  try { localStorage.setItem('vteng_bookmarks', JSON.stringify([...set])); } catch (e) {}
}
...
function getProgress() {
  try { return JSON.parse(localStorage.getItem('vteng_progress') || '{}'); }
  catch (e) { return {}; }
}
function setProgress(id, val) {
  try { const p = getProgress(); p[id] = val; localStorage.setItem('vteng_progress', JSON.stringify(p)); }
  catch (e) {}
}
