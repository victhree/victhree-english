...
$root='C:\Users\ASUS\victhree-english'
$dataDir="$root\docs\data"

# preferred section order (others appended alphabetically)
$subjectOrder=@('Spotting Errors','Reading Comprehension','Ordering of Words','Ordering of Sentences','Fill in the Blanks','Cloze','Parts of Speech / Word Classes','Prepositions & Determiners','Sentence Completion','Sentence Improvement','Other Grammar')
# topic display order per section (topics here are the two families)
$bucketOrder=@('Grammar & Usage','Comprehension & Ordering')
...
$manifest=[ordered]@{
  ...
  tagline='CDS English Previous Year Questions'
  updated=''
